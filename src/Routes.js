...
const Routes = () => (
  <Switch>
    <Route path={['/debugger/:entrypointAddress/:segment/:organizationAddress', '/debugger/:entrypointAddress/:segment/', '/debugger/:entrypointAddress', '/debugger', '/debugger.html']} component={Debugger} />
